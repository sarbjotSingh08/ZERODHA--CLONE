    ...
    return (
      <footer style={{backgroundColor:"rgb(250,250,250"}}>
        <div className='container border-top mt-5' >
          ...
          <p className='mt-4'>© 2010 - 2025, Zerodha Broking Ltd.<br></br>
...
<a href="" className='text-muted' style={{textDecoration:"none"}}>Open source</a><br></br>
                ...
                <div className='col'>
 <p className='fs-4'>Quick links
</p>
                          <a href=""  className='text-muted' style={{textDecoration:"none",marginBottom:"20px"}}>Upcoming IPOs</a> <br></br>
